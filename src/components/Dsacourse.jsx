    ...
    <>
      ...
      >
            ...
            <div className="w-full md:w-1/2 p-2">
              <ul>
                <li className="flex items-center">
                  ...
                  Develop Your Analytical skills on Data structure and use them
                  effectively
                </li>
                <li className="flex items-center">
                  <span className="text-red-500 mr-2">✔️</span>
            ...
            >
              ...
              {paragraphStates[`paragraph${item}`] && (
                <p className="mt-4">
                  ...
                  Nullam suscipit, justo sed malesuada posuere, turpis arcu
                  ultrices lectus, eget fringilla justo mi eu est. Phasellus
                  fermentum, arcu vel pharetra facilisis, sem purus ultricies
                  lacus, nec vestibulum velit ex sit amet lacus. In hac
        ...
        >
          ...
          <div className="ml-[5%] dark:text-[#050608] mt-4 text-white">
          ...
          <div className="max-w-xl mx-auto p-6 mb-10 md:mb-4  bg-gradient-to-r from-[#ED374D] to-[#FA793F] w-full dark:  shadow-lg rounded-lg ml-[5%]">
            <div className="flex ">
              ...
              <div>
                <div className="text-2xl mt-0 text-white">
