	...
	const testimonialData = [
		{
			...
			testimony1:
				"The complete guide to build a full-stack app with Next.js",
		    testimony2:"how to build a complete full stack web dev app using next.js,prism orm,tailwind,NextUi and NextAuth",		
            educator: "Mary", 
			rating: 4.9,   
		},
		{
