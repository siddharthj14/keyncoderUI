...
const Sidebar = () => {
  ...
  const modules = [
    { name: 'Module1', videos: [{title: 'Chapter 1', link: 'https://www.youtube.com/watch?v=LXb3EKWsInQ'}, {title: 'Chapter 2', link: 'https://www.youtube.com/watch?v=xyz2'},{title: 'Chapter 3', link: 'https://www.youtube.com/watch?v=xyz2'},{title: 'Chapter 4', link: 'https://www.youtube.com/watch?v=xyz2'}] },
    { name: 'Module2', videos: [{title: 'chapter 1', link: 'https://www.youtube.com/watch?v=xyz3'}, {title: 'chapter 2', link: 'https://www.youtube.com/watch?v=xyz4'},{title: 'Chapter 3', link: 'https://www.youtube.com/watch?v=xyz2'},{title: 'Chapter 4', link: 'https://www.youtube.com/watch?v=xyz2'}] },
    { name: 'Module3', videos: [{title: 'chapter 1', link: 'https://www.youtube.com/watch?v=xyz5'}, {title: 'chapter 2', link: 'https://www.youtube.com/watch?v=xyz6'},{title: 'Chapter 3', link: 'https://www.youtube.com/watch?v=xyz2'},{title: 'Chapter 4', link: 'https://www.youtube.com/watch?v=xyz2'}] },
    { name: 'Module4', videos: [{title: 'chapter 1', link: 'https://www.youtube.com/watch?v=xyz7'}, {title: 'chapter 2', link: 'https://www.youtube.com/watch?v=xyz8'},{title: 'Chapter 3', link: 'https://www.youtube.com/watch?v=xyz2'},{title: 'Chapter 4', link: 'https://www.youtube.com/watch?v=xyz2'}] },
  ...
  return (
    <div className='flex'>
      <div className="h-screen overflow-y-auto p-4 border-b-10 border-black w-[15%] mt-20">
        {modules.map((module, index) => (
          <div key={index} className="border-b border-red-500">
            ...
            >
              {module.name}
              <FontAwesomeIcon icon={expandedModules[module.name] ? faChevronUp : faChevronDown} className='text-red-500'/>
            </div>
      ...
      <div className='flex-grow p-4 mt-20 '>
        {selectedVideo ? (
          <ReactPlayer url={selectedVideo} controls={true} width='100%' height='90%' />
        ) : (
