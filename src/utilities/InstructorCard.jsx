		...
		<div className='max-w-xl mx-auto p-6 mb-10 md:mb-4  bg-gradient-to-r from-[#717171] via-[#575656] to-[#C3C3C3] dark:  shadow-lg rounded-lg ml-12'>
			<div className='flex mt-4'>
				<div className='mr-4'>
					...
					/>
          <div className="text-center mt-2 ml-[10%] dark:text-black text-lg font-bold">{name}</div>
					<div className="text-center mt-0 ml-[7%] text-lg font-bold">{surname}</div>
				</div>
				<div>
					...
					<div><img src="public/play.png" alt="" /></div>
					...
					<p className="mt-4 text-black font-extrabold"> Over 20 plus years of experience in computer science and information technology field</p>
				</div>
			</div>
		</div>
	);
