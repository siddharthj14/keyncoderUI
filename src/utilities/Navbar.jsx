    ...
    >
      <div className="flex items-center justify-between w-full small:w-auto">
        <span className="flex items-center gap-2">
          <Link to="/">
            <img
              src={theme === "light" ? "/images/logo.png" : "/images/logolight.png"}
              alt=""
              className="w-40 h-10"
            />
          </Link>
        ...
        <ul className="flex gap-7">
          <li>
            <Link
              ...
              className={`font-medium dark:text-white ${
                activeLink === 0 ? "text-orange-600 underline decoration-2 decoration-orange-400 underline-offset-8" : ""
          ...
          <li>
            <Link
              to="/batches"
              className={`font-medium dark:text-white ${
                activeLink === 1 ? "text-orange-600 underline decoration-2 decoration-orange-400 underline-offset-8" : ""
              } hover:text-orange-600`}
              onClick={handleLinkClick}
            >
              Batches
          ...
          <li>
            <Link
              to="/contact-us"
              className={`font-medium dark:text-white ${
                activeLink === 2 ? "text-orange-600 underline decoration-2 decoration-orange-400 underline-offset-8" : ""
              } hover:text-orange-600`}
              onClick={handleLinkClick}
            >
              Contact Us
