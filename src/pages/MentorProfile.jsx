				...
				<div className='flex md:flex-row flex-col justify-center p-12 md:px-[200px] px-12  '>
					<div className='flex flex-col lg:w-[60%] w-full'>
						<div className='mt-8'>
							...
							<p className='mt-2 w-[80%] text-[#999999] font-thin leading-[1.75rem]'>
								About Mentor Lorem ipsum dolor sit amet, consectetur adipiscing elit,
								sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis
								ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas
								accumsan lacus vel facilisis consectetur adipiscing elit. Lorem ipsum
					...
					<div className='mt-8 bg-card rounded-lg h-fit w-[400px] p-4 bg-gradient-to-tr from-[#2D2C2C] to-[#464646]'>
						<div className='flex justify-between items-center'>
							<h2 className='text-xl font-bold  text-[#FF6652] '>Total Course</h2>
							<p className='mt-2 text-orange-600'>30</p>
						</div>
						<div className='flex justify-between items-center'>
							<h2 className='text-xl font-bold text-[#FF6652]  mt-4'>Ratings</h2>
							<p className='mt-2'>{mentor.rating} (<span className="text-orange-600">135</span>)</p>
						</div>
						<div className='flex justify-between items-center'>
							<h2 className='text-xl font-bold text-[#FF6652]  mt-4'>Experiences</h2>
							<p className='mt-2'>10 Years</p>
						</div>
						<div className='flex justify-between items-center'>
							<h2 className='text-xl font-bold  text-[#FF6652] mt-4'>Graduated</h2>
							<p className='mt-2'>Yes</p>
						</div>
						<div className='flex justify-between items-center'>
							<h2 className='text-xl font-bold  text-[#FF6652] mt-4'>Language</h2>
